...
required=(
  ...
  "POKE64/App/LibraryStore.swift"
  "POKE64/App/LibraryView.swift"
...
grep -q 'LibraryStore' "${ROOT}/POKE64/App/EmulatorModel.swift"
grep -q 'LibraryView' "${ROOT}/POKE64/App/ContentView.swift"
grep -q 'library.json' "${ROOT}/POKE64/App/LibraryStore.swift"
